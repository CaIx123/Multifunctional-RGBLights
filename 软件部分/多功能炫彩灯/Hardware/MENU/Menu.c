...
void LCD_UpdatePage(uint8_t CurrentPage0,uint8_t CurrentPage1)
{
	uint8_t i;
	uint16_t x=80,y=40;
//	LCD_ShowNum(60,50,PictStorageNum,1);
//	LCD_ShowNum(60+16,50,BackNum,1);
		...
		case 3:		//BackSet
			switch(CurrentPage[1])
			{
				case 0:
					...
					{
						case 4:		//Picture
							if(Func_count==1)Show_Function(2,1,1);
							if(Back_Flag)
							{
								FunctionStopFlag=1,Func_count=1,ReturnShowNum=0;;
								MenuUpdateFlag[0]=0,MenuUpdateFlag[2]=2;
							}
							if(Sure_Flag)
							{
								Sure_Flag=0,Func_count++/*,FunctionStopFlag=1*/;
								if(Func_count>2) 
								{
									FunctionStopFlag=1,Func_count=1;
									MenuUpdateFlag[0]=0,MenuUpdateFlag[2]=2;
								...
								if(GetShowPicture(NumGet)) ReturnShowNum=0;
								else ReturnShowNum=4,FunctionStopFlag=0;
							}
							break;
					}
					break;
...
//MenuUpdateFlag[3]
							...
							{
								Sure_Flag=0,FunctionStopFlag=1;
								if(GetShowPicture(NumGet)) 
								{
									BackNum=NumGet,ReturnShowNum=0;
									StorageData(3);
									MenuUpdateFlag[0]=1,MenuUpdateFlag[1]=1,MenuUpdateFlag[2]=2;
								}
								else ReturnShowNum=4;
							}
							break;
				...
				case 2:		//BackColor
					switch(MenuPage[CurrentPage[0]][CurrentPage[1]].CurrentChoice)
					{
						...
						case 3:		//BackColor
							...
							if(Sure_Flag)
							{
								Sure_Flag=0,FunctionStopFlag=1,ReturnShowNum=0;
