...
void LCD_Menu_Init()
{
	...
	strcpy(MenuPage[0][0].Str[1],"FlowiSet ");
	strcpy(MenuPage[0][0].Str[2],"IFaceSet ");
	strcpy(MenuPage[0][0].Str[3],"WeathSet ");
	/*第二级 	4*/
	MenuPage[1][0].ChoiceNum=4;
	MenuPage[1][0].CurrentChoice=1;
	strcpy(MenuPage[1][0].Str[0],"TypeGett ");
	strcpy(MenuPage[1][0].Str[1],"TypeSave ");
	strcpy(MenuPage[1][0].Str[2],"TypeAdju ");
	strcpy(MenuPage[1][0].Str[3],"TypeIndi ");
	
	MenuPage[2][0].ChoiceNum=3;
	MenuPage[2][0].CurrentChoice=1;
	strcpy(MenuPage[2][0].Str[0],"TypeSelf ");
	strcpy(MenuPage[2][0].Str[1],"Types?   ");
	strcpy(MenuPage[2][0].Str[2],"Interval ");
	...
	/*第三级 	15*/
	MenuPage[1][1].ChoiceNum=0;
	MenuPage[1][1].CurrentChoice=0;
	
	MenuPage[1][2].ChoiceNum=0;
	MenuPage[1][2].CurrentChoice=0;
	
	MenuPage[1][3].ChoiceNum=3;
	MenuPage[1][3].CurrentChoice=1;
	strcpy(MenuPage[1][3].Str[0],"On       ");
	strcpy(MenuPage[1][3].Str[1],"Off      ");
	strcpy(MenuPage[1][3].Str[2],"ReSet    ");
	
	MenuPage[1][4].ChoiceNum=3;
	MenuPage[1][4].CurrentChoice=1;
	strcpy(MenuPage[1][4].Str[0],"Num?To?  ");
	strcpy(MenuPage[1][4].Str[1],"R?G?B?   ");
	strcpy(MenuPage[1][4].Str[2],"Color?   ");
	...
	MenuPage[3][2].ChoiceNum=0;
	MenuPage[3][2].CurrentChoice=0;
	MenuPage[3][3].ChoiceNum=0;
	MenuPage[3][3].CurrentChoice=0;
				...
				case 0:
					switch(MenuPage[CurrentPage[0]][CurrentPage[1]].CurrentChoice)
					{
						...
						case 2:
							...
							{
								Sure_Flag=0,FunctionStopFlag=1;
								if(GetType(NumGet))ReturnShowNum=3;
								else ReturnShowNum=4;
							}
							break;
					}
		...
		case 2:
			switch(MenuPage[CurrentPage[0]][CurrentPage[1]].CurrentChoice)
			{
				case 1:
					...
					break;
				case 2:
					Show_Function(1,Func_count,3);
					if(Sure_Flag)
					{
						Sure_Flag=0,NumGet=0;
						Func_count++;
						if(Func_count>3) FunctionStopFlag=1,Func_count=1;
					}
					break;
				case 3:
					Show_Function(4,1,1);
